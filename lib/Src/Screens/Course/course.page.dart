...
class CourseScreen extends StatefulWidget {
  ...
  const CourseScreen({Key? key, required this.image, required this.courseType})
      : super(key: key);
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          } /*"Android Developement"*/, courseImages[index],
                              courseInstructorNames[index], courseNames[index]);
                        },
                      ),
                    ),
                  ],
